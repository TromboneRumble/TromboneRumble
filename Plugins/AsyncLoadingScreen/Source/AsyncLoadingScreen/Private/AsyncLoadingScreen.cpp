...
FOnAsyncLoadingScreenFinished FAsyncLoadingScreenModule::LoadingScreenFinished;
...
void FAsyncLoadingScreenModule::StartupModule()
{
	...
	if (!IsRunningDedicatedServer() && FSlateApplication::IsInitialized())
	{
		...
		if (IsMoviePlayerEnabled())
		{
			...
			GetMoviePlayer()->OnMoviePlaybackFinished().AddRaw(this, &FAsyncLoadingScreenModule::HandleMovieFinished);
		}		
...
void FAsyncLoadingScreenModule::HandleMovieFinished()
{
