...
DECLARE_MULTICAST_DELEGATE(FOnAsyncLoadingScreenFinished);
...
public:
	...
	static FOnAsyncLoadingScreenFinished& OnLoadingScreenFinished()
	{
...
private:
	...
	static FOnAsyncLoadingScreenFinished LoadingScreenFinished;
