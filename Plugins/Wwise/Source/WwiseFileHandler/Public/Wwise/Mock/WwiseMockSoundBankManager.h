...
public:
	...
	void LoadSoundBank(const FWwiseSoundBankCookedData& InSoundBankCookedData, const FString& InRootPath, FLoadSoundBankCallback&& InCallback)
	{
		...
		IncrementFileStateUseAsync(InSoundBankCookedData.SoundBankId, EWwiseFileStateOperationOrigin::Loading, [WeakThis=AsWeak(), InSoundBankCookedData, InRootPath]() mutable
		{
			...
			return SharedMockSoundBankManager->CreateOp(InSoundBankCookedData, InRootPath);
