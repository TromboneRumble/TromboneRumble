...
public:
	                                ...
	                                const FWwiseLanguageCookedData& InLanguage, FLoadExternalSourceCallback&& InCallback) override
	{
		...
		IncrementFileStateUseAsync(InExternalSourceCookedData.Cookie, EWwiseFileStateOperationOrigin::Loading, [WeakThis=AsWeak(), InExternalSourceCookedData, InRootPath]() mutable 
		{
			...
			return SharedMockExternalSourceManager->CreateOp(InExternalSourceCookedData, InRootPath);
