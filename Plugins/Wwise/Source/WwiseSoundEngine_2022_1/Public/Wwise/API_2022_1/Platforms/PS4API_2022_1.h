...
#include "Wwise/API/Platforms/PS4API.h"

#if defined(PLATFORM_PS4) && PLATFORM_PS4

class FWwisePlatformAPI_2022_1_PS4 : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2022_1_PS4);
	FWwisePlatformAPI_2022_1_PS4() = default;
	virtual ~FWwisePlatformAPI_2022_1_PS4() override {}
	...
	virtual int GetPS4OutputHandle(AkOutputDeviceID deviceId = 0) override;
	...
	virtual int GetSceAudio3dPortId() override;
};

using FWwisePlatformAPI = FWwisePlatformAPI_2022_1_PS4;
