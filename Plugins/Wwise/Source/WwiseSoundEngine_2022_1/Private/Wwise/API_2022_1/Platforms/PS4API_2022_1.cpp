...
#include "Wwise/API_2022_1/Platforms/PS4API_2022_1.h"
#include "Wwise/Stats/SoundEngine_2022_1.h"

#if defined(PLATFORM_PS4) && PLATFORM_PS4
int FWwisePlatformAPI_2022_1_PS4::GetPS4OutputHandle(AkOutputDeviceID deviceId)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
	return AK::GetPS4OutputHandle(deviceId);
}

int FWwisePlatformAPI_2022_1_PS4::GetSceAudio3dPortId()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
