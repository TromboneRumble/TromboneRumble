...
#include "Wwise/API/Platforms/XboxOneGDKAPI.h"

#if defined(PLATFORM_XBOXONEGDK) && PLATFORM_XBOXONEGDK

class FWwisePlatformAPI_2023_1_XboxOneGDK : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2023_1_XboxOneGDK);
	FWwisePlatformAPI_2023_1_XboxOneGDK() = default;
	virtual ~FWwisePlatformAPI_2023_1_XboxOneGDK() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2023_1_XboxOneGDK;
