...
class FWwisePlatformAPI_2023_1_XSX : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2023_1_XSX);
	FWwisePlatformAPI_2023_1_XSX() = default;
	virtual ~FWwisePlatformAPI_2023_1_XSX() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2023_1_XSX;
