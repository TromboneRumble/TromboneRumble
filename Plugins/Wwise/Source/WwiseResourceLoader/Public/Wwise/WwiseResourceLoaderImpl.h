...
typedef TSharedPtr<FWwiseResourceLoaderImpl> FWwiseResourceLoaderImplPtr;
...
class WWISERESOURCELOADER_API FWwiseResourceLoaderImpl: public TSharedFromThis<FWwiseResourceLoaderImpl>
{
public:
	using FWwiseSetLanguageFuture = TWwiseFuture<void>;
	using FWwiseSetLanguagePromise = TWwisePromise<void>;

	static FWwiseResourceLoaderImplPtr Instantiate()
	{
