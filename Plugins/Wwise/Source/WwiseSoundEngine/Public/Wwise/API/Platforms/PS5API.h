...
public:
	...
	virtual SceAudioOut2PortHandle GetAudioOut2PortHandle(AkOutputDeviceID deviceId = 0) = 0;
	...
	virtual AKRESULT LoadVorbisHwAcceleratorLibrary(const AkOSChar* in_DllName, const AkOSChar* in_DllPath = NULL) = 0;
	...
	virtual void GetAudioOut2SpeakerAngles(AkReal32 out_pfSpeakerAngles[3], AkReal32 &out_rfHeightAngle, const SceAudioOut2SpeakerInfo &in_rInfo) = 0;
};
